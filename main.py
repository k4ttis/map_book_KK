...
def show_user_details():
    ...
    map_widget.set_position(users[i].get_coordinates()[0],users[i].get_coordinates()[1])
...
button_dodaj_obiekt.grid(row=5, column=1)


# ramka_szczegoly_obiektow
label_szcegoly_obiektow=Label(ramka_szczegoly_obiektow, text="Szczegoly obiekt:")
label_szcegoly_obiektow.grid(row=0, column=0)
